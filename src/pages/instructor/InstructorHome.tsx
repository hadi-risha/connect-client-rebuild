...
import std5 from "../../images/std5.png";
import std6 from "../../images/std6.png";
import std7 from "../../images/std7.png";
import std8 from "../../images/std8.png";
import std9 from "../../images/std9.png";
import biology from "../../images/biology.png";
import statistics from "../../images/statistics.png";
import publicSpeaking from "../../images/publicSpeaking.png";
import instructor8 from "../../images/instructor8.jpeg";
import instructor9 from "../../images/instructor9.jpeg";
import instructor14 from "../../images/instructor14.jpeg";
...
const InstructorHome = () => {
    ...
    return (
        <div className='w-full h-auto overflow-x-hidden'>
            ...
            {/*   BG-IMAGE SECTION   */}
            <div className="w-full bg-cover bg-center h-auto" style={{ backgroundImage: `url(${homeBg})` }}>

                {/* header - never remove */} 
                <div className="flex justify-between items-center px-8 mx-16">
                </div>
                ...
                <div className='mt-[30vh] flex justify-center items-center flex-col'>
                    ...
                    <p className='text-black mt-10 text-2xl font-normal'>Build your professional presence, showcase your expertise, and guide learners</p>
                    <p className='text-black text-2xl font-normal'>on a platform designed to amplify your impact as an instructor.</p>

                    <button 
                        onClick={() => {
                            navigate('/instructor/sessions'); 
                        }}
                        className="w-40 h-14 mt-28 bg-[#3ee1a6] text-black font-semibold flex items-center justify-center rounded-full shadow-md border border-black relative overflow-hidden group transition duration-700 cursor-pointer">
            ...
            <div className='h-[80vh] w-full mt-32 text-2xl md:text-2xl lg:text-6xl font-serif flex'>
                ...
                <button 
                    ...
                    className="mt-40 mr-28 w-20 h-20 border-2 border-black text-black rounded-full flex items-center justify-center shadow-lg hover:bg-[#3ee1a6] transition duration-300 ml-auto cursor-pointer">
            ...
            <div className='ml-32 mr-36  shadow h-[90vh]  flex '>
                ...
                <div className="h-full w-6/12  pl-14 pt-36">
                    ...
                    className='w-4/12 h-14 py-1 px-4 border border-black bg-[#c291fe] text-black font-semibold rounded-full flex items-center justify-center cursor-pointer'
                    >
                        Get Started
                    </button>
            ...
            <div className='ml-32 mr-36 mb-32 pt-44 pl-14 pb-14 h-auto shadow flex  bg-[#2cc58a]'> 
                ...
                <div className="h-full w-6/12 pl-14">
                    ...
                    className="w-64 h-14 bg-white text-black font-semibold flex items-center justify-center rounded-full shadow-md border border-black relative overflow-hidden group transition duration-700 cursor-pointer">
