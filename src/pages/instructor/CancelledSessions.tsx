...
const InstructorCancelledSessions = () => {
  ...
  if (!instructorBookings.length) {
    return (
      <EmptyState
        ...
        description="You don’t have any sessions that were cancelled."
      />
    );
  }
  ...
  return (
    <div className="min-h-screen px-6 py-8">
      <h1 className="text-2xl font-bold mb-4">Cancelled Sessions</h1>
...
export default InstructorCancelledSessions;
