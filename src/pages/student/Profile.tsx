    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-3xl shadow-md border border-gray-100 overflow-hidden">
          ...
          {/* Cover */}
          <div className="h-32 bg-gradient-to-r from-slate-800 via-slate-700 to-slate-800" />
          ...
          <div className="px-8 pb-8">
            ...
            <div className="flex flex-col items-center -mt-14 text-center">
              ...
              <span className="mt-2 inline-block px-3 py-1 text-xs font-medium rounded-full bg-indigo-100 text-indigo-600">
                {user.role}
              </span>
            </div>
